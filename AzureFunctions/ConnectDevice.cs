...
namespace AzureFunctions
{
    ...
    {
        private static readonly RegistryManager registryManager = RegistryManager.CreateFromConnectionString(Environment.GetEnvironmentVariable("IotHub"));
            ...
            ILogger log)
        {
            ...
            {
                return new BadRequestObjectResult(new HttpDeviceResponse("Device connection failure", ex.Message));
            }
